...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    body: `Every few months, my knee tweaks. I train Judo, and between the jumping, the pivoting, and the takedowns, it happens. What I want to show you here isn't a diagnosis or a fix for a specific injury. It's the exact routine I go through myself the moment it happens, before it turns into something bigger.
...
Because I do Judo, when my knee tweaks it's usually not the knee that's actually weak. It's the ankle. So I do tib raises to strengthen my ankles. You can do these loaded, with a tib bar, or against a wall if you don't have one.

I need a lot of ankle and tib strength for Judo specifically, because I'm often jumping on one leg to take another person down, and that jump has to be absorbed by something. If my tibs are strong, they absorb that force. If they're not, my knee ends up absorbing it instead, and that's what causes irritation or pain.

### Solo ankle rotations

I also do solo ankle rotations, because between falling, tripping, and everything else that comes with Judo, I want my weaker ankle doing extra work. I use an ankle weight: five rotations clockwise, five counterclockwise, then back and forth until failure. This helps bring my weaker ankle up to speed with my stronger one.

### Recovery split squats

When I have a tweak or an injury, I still do split squats, but for recovery, not for strength, and that distinction matters. Normally I'll load 20 lbs in each hand. When I'm recovering, that's too heavy. I drop down to about 10 lbs in each hand, or no weight at all.
